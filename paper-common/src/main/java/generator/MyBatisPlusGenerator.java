...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\StudyTools\\IntelliJ IDEA 2019.1.1\\workspace\\Technique\\paper\\CodeGeneration")//这里写你自己的java目录
        ...
        dsc.setDbType(DbType.MYSQL)
                ...
                .setUsername("root")
                .setPassword("123456")
                .setUrl("jdbc:mysql://127.0.0.1:3306/paper?characterEncoding=utf8");

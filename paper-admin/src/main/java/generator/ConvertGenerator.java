...
public class ConvertGenerator {
    public static void main(String[] args) {
        ...
        try {
            ...
            Class clazz = Class.forName("com.henu.paperadmin.domain.PlanDO");//根据类名获得其对应的Class对象 写上你想要的类名就是了 注意是全名 如果有包的话要加上 比如java.Lang.String
            Class clazzB = Class.forName("com.henu.paperadmin.dto.PlanDTO");

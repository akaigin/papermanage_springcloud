package com.bootdo.clouddoadmin.handler;



import com.bootdo.clouddoadmin.handler.exception.ArgumentsFailureException;
import com.bootdo.clouddoadmin.handler.exception.AuthFailureException;
import com.bootdo.clouddoadmin.handler.exception.NotAuthException;
import com.bootdo.clouddoadmin.handler.exception.NotAuthorityException;
import com.bootdo.clouddocommon.exception.CDException;
import com.bootdo.clouddocommon.response.BaseResponse;
import com.bootdo.clouddocommon.response.SimpleResponse;
...
import static com.bootdo.clouddocommon.response.HttpResponse.baseResponse;
import static com.bootdo.clouddocommon.response.HttpResponse.simpleResponse;
...
public final class ExceptionAdviceHandler {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResultBean argsErrorExceptionHandler(ArgumentsFailureException ex, HttpServletResponse response) {
        return ResultBean.error(400, ex.getMessage());
    }
